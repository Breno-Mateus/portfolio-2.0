    ...
    return (
        <section className="bg-colorPrimary flex flex-col md:flex-row justify-center md:justify-between items-center py-16 px-[10%] gap-20 min-h-screen">
            <div className="md:w-[38%]">
                <h3 className="text-[1.5rem] md:text-[2rem] font-extrabold text-colorStyle">&lt; Desenvolvedor Frontend &gt;</h3>
                ...
                <button className="bg-colorStyle text-xs md:text-base py-1 px-2 rounded-md hover:opacity-85 font-medium">Download CV</button>
            </div>
